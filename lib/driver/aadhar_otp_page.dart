...
class Aadhar_otp_page extends StatefulWidget {
  const Aadhar_otp_page({Key? key}) : super(key: key);

  @override
  State<Aadhar_otp_page> createState() => _Aadhar_otp_pageState();
}

class _Aadhar_otp_pageState extends State<Aadhar_otp_page> {
